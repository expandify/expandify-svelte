package dev.kenowi.exportify.domain.service.auth;
...
import dev.kenowi.exportify.domain.service.credentials.CredentialsService;
import dev.kenowi.exportify.domain.service.exportifyuser.ExportifyUserService;
import dev.kenowi.exportify.domain.service.spotifyuser.SpotifyUserService;
...
public class AuthenticationService {
    ...
    public AbstractAuthenticationToken parsePrincipal(Jwt source) {
        return new AuthenticatedUser(source, credentialsService, exportifyUserService);
    }
