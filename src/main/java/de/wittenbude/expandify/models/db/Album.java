...
public class Album {
    ...
    public Album(se.michaelthelin.spotify.model_objects.specification.Album album, List<TrackInfo> tracks) {
        this.albumType = album.getAlbumType();
        this.artists = Arrays.stream(album.getArtists()).map(ArtistInfo::new).toList();
